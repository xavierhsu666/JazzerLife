...
-- 插入範例銀行帳戶資料
INSERT INTO OMT.DX_JZ_BankAccount
...
-- 插入範例零件分類資料
INSERT INTO OMT.DX_JZ_PartCategories
    (UserID, CategoryName)
VALUES
    (1, 'Engine'),
    (2, 'Brakes'),
...
-- 插入範例車輛資料
INSERT INTO OMT.DX_JZ_Vehicles
...
-- 插入範例燃料消耗記錄
INSERT INTO OMT.DX_JZ_FuelConsumption
...
-- 插入範例零件維護記錄
INSERT INTO OMT.DX_JZ_PartsMaintenance
...
-- 插入範例維護商店聯絡資料
INSERT INTO OMT.DX_JZ_MaintenanceShops
...
-- 插入範例維護週期資料
INSERT INTO OMT.DX_JZ_MaintenanceCycles
