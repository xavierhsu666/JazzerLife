-- 插入範例用戶資料
INSERT INTO Mem.Users (UserName, Email, PasswordHash, PhoneNumber)
VALUES 
...
-- 插入範例車輛資料
INSERT INTO CarMan.Vehicles (UserID, Make, Model, Year, LicensePlate)
VALUES 
...
-- 插入範例燃料消耗記錄
INSERT INTO CarMan.FuelConsumption (VehicleID, Date, OdometerReading, FuelAmount, FuelCost)
VALUES 
...
-- 插入範例零件維護記錄
INSERT INTO CarMan.PartsMaintenance (VehicleID, PartName, MaintenanceDate, Cost, Notes, CategoryID, OdometerReading, Description)
VALUES 
...
-- 插入範例維護商店聯絡資料
INSERT INTO CarMan.MaintenanceShops (UserID, ShopName, ContactPerson, PhoneNumber, Address)
VALUES 
...
-- 插入範例維護週期資料
INSERT INTO CarMan.MaintenanceCycles (UserID, PartName, TimeCycle, MileageCycle)
VALUES 
...
-- 插入範例銀行帳戶資料
INSERT INTO FIN.BankAccount (UserID, IDNumber, OrganizationName, AccountName, Currency, CreditLimit, AccountBalance, AvailableCredit)
VALUES 
(1, 'N126***819', '中華郵政', '中華郵政', 'TWD', 0, 543, 0),
(1, 'N126***819', '台新銀行', '敦南Richart', 'TWD', 0, 12509, 0);

-- 插入範例帳單資料
INSERT INTO FIN.Bill (UserID, OrganizationName, BillType, BillAmount, MinimumPayment, DueDate)
VALUES 
...
-- 插入範例明細資料
INSERT INTO FIN.Detail (UserID, IDNumber, OrganizationName, AccountName, Category, Description, Currency, Amount, TransactionDate, PostingDate)
VALUES 
...
-- 插入範例股票資料
INSERT INTO FIN.Stock (UserID, OrganizationName, AccountName, Code, Unit, MarketValue, Cost, UnRealizedBenefit, UnRealizedBenefitRatio)
VALUES 
